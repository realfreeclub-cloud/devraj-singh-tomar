          ...
          <div className="lg:w-1/3 flex flex-col gap-10">
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-4">
                ...
                <Link href="https://www.facebook.com/DevrajSinghTomarIT" className="p-4 bg-layer border border-layer-border rounded-xl hover:bg-[#1877F2] hover:text-white transition-colors text-foreground cursor-none" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                ...
                <Link href="https://github.com/devrajsingh-tomar" className="p-4 bg-layer border border-layer-border rounded-xl hover:bg-[#333333] hover:text-white transition-colors text-foreground cursor-none" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
                  <GithubIcon size={24} />
                </Link>
              </div>
            </div>
